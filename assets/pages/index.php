  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-expand fixed-top">
      <div class="navbar-brand d-none d-lg-block">
        <a href="index.php"><img src="../images/logo.png" class="img-fluid logo"></a>
      </div>
          ...
          <ul class="nav navbar-nav align-items-center">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-right logged-user-menu">
                <li><a href="?page=index&aksi=editpp&id=<?php echo $data['id']; ?>"><i class="ti-setting"></i> <span>Edit Profile</span></a></li>
    ...
    <div id="sidebar-nav" class="sidebar">
      <nav>
        <ul class="nav" id="sidebar-nav-menu">
          ...
          <li><a href="?page=index&aksi=agen" class=""><i class="ti-user"></i> <span class="title">Cari Agen</span></a></li>
          <li><a href="?page=index&aksi=kategori" class=""><i class="ti-receipt"></i> <span class="title">Rumah</span></a></li>
      ...
      <div class="main-content">
        ...
        <div class="content-heading">
          <div class="heading-left">
            ...
            ?>
            <h1 class="page-title">Selamat Datang <?php echo $datauser['nama'] ?></h1>
            <p class="page-subtitle">Cari property yang anda inginkan</p>
          </div>
        </div>
